...
Run `php artisan vendor:publish --provider="dev0ehab\Larafirebase\Providers\LarafirebaseServiceProvider"` to publish the `larafirebase.php` config file.
...
use dev0ehab\Larafirebase\Messages\FirebaseMessage;
